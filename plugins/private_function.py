        ...
        if sudo2(m):
            try:
                ...
                if lang is None:
                    ...
                    t = "\n✧ قائمة المطورين \n\n" + f"✧ [Hasnen | حسنين](tg://user?id={super_sudoers[0]})\n" + f"✧ [{n.first_name}](tg://user?id={sudoers[0]})\n\n"
                    for row in lang:
...
########################################################################################################################
    ...
    if m.text == "السورس" or m.text == "سورس" or m.text == "يا سورس":
        ...
        await m.reply_text("""
- [𝗦𝗢𝗨𝗥𝗖𝗘 Black](t.me/aa_ggc)
- [𝗔𝗦𝗞 𝗧𝗢 𝗠𝗘](t.me/aa_ggc)
- [Black](t.me/zzhhzhg)
Welcome to Source Black
    ...
    if m.text == "id" or m.text == "ايدي" or m.text == "ايدى" or m.text == "الايدي" or m.text == "ا" or m.text == "الايدى" or m.text == "ايديه":
    ...
    if m.text == "بوت" or m.text == "البوت":
        if sudo2(m):
            ...
            if manager(m):
                await m.reply_text("وش تبي !؟\n")
            else:
                if constractors(m):
                    await m.reply_text("اسمي بلاك ترااا\n")
                else:
                    if admin(m):
                        await m.reply_text("بلاكك اسميي هيوو\n")
                    else:
                        if special(m):
                            await m.reply_text("بلاك اسمي حبي\n")
                        else:
    ...
    if m.text == (get_db_botname() or "بلاك"):
