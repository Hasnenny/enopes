...
async def hinterx(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="anmie2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
...
async def hinterx2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="hinterx1 " + str(m.from_user.id))] +
...
async def hinterx3(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="hinterx2 " + str(m.from_user.id))] +
...
async def hinterx4(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="hinterx3 " + str(m.from_user.id))] +
...
async def hinterx5(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="hinterx4 " + str(m.from_user.id))] +
...
async def hinterx6(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="hinterx5 " + str(m.from_user.id))] +
...
async def hinterx7(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="hinterx6 " + str(m.from_user.id))],
        [InlineKeyboardButton("القائمه الرئيسيه ", callback_data="anmie2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
...
async def tokyo(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="hinterx " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
...
async def tokyo2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="tokyo1 " + str(m.from_user.id))] +
...
async def tokyo3(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="tokyo2 " + str(m.from_user.id))] +
...
async def tokyo4(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="tokyo3 " + str(m.from_user.id))],
        [InlineKeyboardButton("القائمه الرئيسيه ", callback_data="anmie2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
    ])
...
async def hgoom2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="hgoom1 " + str(m.from_user.id))] +
...
async def hgoom3(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="hgoom2 " + str(m.from_user.id))] +
...
async def hgoom4(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="hgoom3 " + str(m.from_user.id))] +
...
async def hgoom5(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="hgoom4 " + str(m.from_user.id))],
        [InlineKeyboardButton("القائمه الرئيسيه ", callback_data="anmie2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
    ])
...
async def fmoslsl(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="cartoon2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
...
async def spong1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="spong " + str(m.from_user.id))] +
...
async def spong2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="spong1 " + str(m.from_user.id))] +
...
async def spong3(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="spong2 " + str(m.from_user.id))] +
...
async def spong4(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="spong3 " + str(m.from_user.id))] +
...
async def spong5(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="spong4 " + str(m.from_user.id))] +
...
async def spong6(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="spong5 " + str(m.from_user.id))] +
        [InlineKeyboardButton("القائمه الرئيسيه ", callback_data="cartoon2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
...
async def dany1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="dany " + str(m.from_user.id))] +
...
async def dany2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="dany1 " + str(m.from_user.id))] +
...
async def dany3(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="dany2 " + str(m.from_user.id))] +
        [InlineKeyboardButton("القائمه الرئيسيه ", callback_data="cartoon2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
...
async def temon1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="temon " + str(m.from_user.id))] +
...
async def temon2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="temon1 " + str(m.from_user.id))] +
        [InlineKeyboardButton("القائمه الرئيسيه ", callback_data="cartoon2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
...
async def snafer1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="snafer " + str(m.from_user.id))] +
...
async def snafer2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="snafer1 " + str(m.from_user.id))] +
...
async def snafer3(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="snafer2 " + str(m.from_user.id))] +
...
async def Xfcartoon2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ", callback_data="Xfcartoon1 " + str(m.from_user.id))],
        [InlineKeyboardButton("القائمه الرئيسيه ", callback_data="cartoon2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
